...
- **Google Suporte em TI** — Google, 2023
- **Administração de Sistemas e Serviços de Infraestrutura de TI** — Google, 2023
- **Segurança de TI: Defesa Contra as Artes Obscuras do Mundo Digital** — Google, 2023
